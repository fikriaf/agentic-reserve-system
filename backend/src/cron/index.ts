...
// import { startPaymentScannerCron } from './payment-scanner'; // Disabled for production build
...
export function initializeCronJobs(): void {
  ...
  // Payment Scanner - Every 60 seconds (configurable) - Disabled for production build
